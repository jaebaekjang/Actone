...
export default async function ResourceSubmitPage({
  ...
  if (submitted) {
    return (
      <div className="mx-auto flex max-w-md flex-col items-center py-16 text-center">
        ...
        <h1 className="mt-4 text-[24px] font-semibold tracking-tight text-foreground">제보 완료</h1>
  ...
  return (
    <div className="mx-auto max-w-[720px]">
      <h1 className="text-[24px] font-semibold tracking-tight text-foreground">자료 제보하기</h1>
